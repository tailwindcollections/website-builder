    ...
    <div className="flex bg-gray-100 font-sans text-gray-900">
      <aside className="flex min-h-screen w-18 flex-col items-center border-r border-gray-200 bg-white">
        ...
        <nav className="flex flex-1 flex-col gap-y-4 pt-10">
          <a
            href="#"
            className="rounded-2xl bg-gray-100 p-2 text-blue-500 hover:bg-gray-50"
          >
        ...
        <div className="flex flex-col items-center gap-y-4 py-10">
          <button className="rounded-2xl p-2 text-gray-400 hover:bg-gray-100">
      ...
      <div className="flex min-h-screen flex-1 flex-col">
        <header className="flex h-20 items-center justify-center gap-x-6 border-b border-gray-200 bg-white px-8">
          ...
          <div className="flex items-center gap-x-2">
            <button className="rounded-2xl bg-gray-100 p-3 text-blue-500">
              <DeviceDesktopIcon className="h-6 w-6 stroke-current" />
            </button>
            <button className="rounded-2xl p-3 text-gray-400 hover:bg-gray-100">
